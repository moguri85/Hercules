 ...
 */
const char* timer_timestamp2string(char* str, size_t size, time_t timestamp, const char* format){
 ...
 */
void timer_split_time(int timein, int* year, int* month, int* day, int* hour, int* minute, int *second) {
 ...
 */
double timer_solve_time(char* modif_p) {
	double totaltime = 0;
	struct tm then_tm;
...
void timer_defaults(void) {
	...
	timer->timestamp2string = timer_timestamp2string;
	timer->split_time = timer_split_time;
	timer->solve_time = timer_solve_time;
